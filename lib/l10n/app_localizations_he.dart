...
class AppLocalizationsHe extends AppLocalizations {
  ...
  @override
  String get placesAddButtonTooltip => 'הוספה';

  @override
  String get placesMenuAddPlace => 'הוספת מקום';

  @override
  String get placesMenuImportList => 'ייבוא רשימת Google Maps…';

  @override
  String get importListDialogTitle => 'ייבוא רשימת Google Maps';

  @override
  String get importListDialogHint => 'הדבקת קישור לרשימת Google Maps';

  @override
  String get importListDialogImport => 'ייבוא';

  @override
  String get importListDialogInvalidLink =>
      'זה לא נראה כמו קישור של Google Maps';

  @override
  String get mapsListImportTitle => 'ייבוא רשימה';

  @override
  String get mapsListImportScraping => 'קוראים את הרשימה…';

  @override
  String get mapsListImportFailedBody =>
      'לא הצלחנו לקרוא את הרשימה הזו מ-Google Maps. אפשר לנסות לשתף מקומות בנפרד';
  ...
  String mapsListImportButton(int n) {
    return 'ייבוא $n מקומות';
  }

  @override
  String mapsListImportProgress(int done, int total) {
    return '$done מתוך $total אותרו';
  }
}
