...
| Redesign Phase 1 — Design-system foundation | [2026-08-14-tripper-redesign-phase1-foundation.md](../superpowers/plans/2026-08-14-tripper-redesign-phase1-foundation.md) | M1-M5 | complete — AppColors/AppShape tokens, Trip.coverPhotoPath schema, generated-gradient helper, GlassChrome primitive, CLAUDE.md/SPEC.md rewritten |

M2 and M3 were independent of each other and could be built in either order after M1. Testing/CI conventions shared by all milestones live at the bottom of M4-polish.md. Live GPS tracking (SPEC §3.2.2) is its own later milestone (M6) — battery-critical, deliberately isolated, not started.
